...
What if I want to create a few non trivial dockerfiles which a share significant amount of code. I introduce a YAML configuration file and a Python script which parses the configuration file. 
